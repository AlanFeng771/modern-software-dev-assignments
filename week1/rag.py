...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = "Complete this task strictly based on the API information provided in the context. Do not guess or assume any details that are not explicitly given. Output the code block that strictly follows correct Python syntax and conventions."
